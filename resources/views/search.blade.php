...
<div class="page-wrapper">
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Cooperações<span style="color: #16C49F ">Resultado</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                        ...
                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="../imagens/{{$pesquisa->imagem}}.jpg" alt="Product image" class="product-image">
                                    </a>
                                    ...
                                    <div class="product-action action-icon-top">
                                        ...
                                        <a href="https://api.whatsapp.com/send?text=/{{$pesquisa->imagem}}"  target="_blank"> <i aria-placeholder="compartilhar" style="font-size: 30px;padding-left: 119px;color: #16C49F;" class="fab fa-whatsapp"></i></a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product.html">{{$pesquisa->nome}}</a></h3><!-- End .product-title -->
